...
var o18180 = temp__5455__auto__;
var temp__5455__auto____$1 = (o18180["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o18181 = temp__5455__auto____$1;
return (o18181["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__17292__auto__ = f;
return (o__17292__auto__["toString"]).call(o__17292__auto__);
} else {
return "";
}
}catch (e18182){var _ = e18182;
return "";
}});
...
try{var o__17292__auto___18184 = t;
(o__17292__auto___18184["cljs$lang$ctorPrWriter"]).call(o__17292__auto___18184,t,writer);
}catch (e18183){var __18185 = e18183;
}
...
var char_code = (function (){var o__17292__auto__ = (new String(char$));
return (o__17292__auto__["charCodeAt"]).call(o__17292__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__17292__auto__ = String;
return (o__17292__auto__["fromCharCode"]).call(o__17292__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__18186 = num_code;
switch (G__18186) {
case (1):
return (185);
...
var o__17292__auto__ = String;
return (o__17292__auto__["fromCharCode"]).call(o__17292__auto__,superscript_code);
});
/**
...
}catch (e18188){var _e__17299__auto__ = e18188;
return false;
}})())){
...
var vec__18189 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__18189,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o18192 = temp__5455__auto__;
var temp__5455__auto____$1 = (o18192["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o18193 = temp__5455__auto____$1;
return (o18193["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___18200 = arguments.length;
var i__4500__auto___18201 = (0);
while(true){
if((i__4500__auto___18201 < len__4499__auto___18200)){
args__4502__auto__.push((arguments[i__4500__auto___18201]));

var G__18202 = (i__4500__auto___18201 + (1));
i__4500__auto___18201 = G__18202;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__18196){
var vec__18197 = p__18196;
var ns_detector = cljs.core.nth.call(null,vec__18197,(0),null);
...
var G__18203 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__18204 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__18203;
remaining_tokens = G__18204;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq18194){
var G__18195 = cljs.core.first.call(null,seq18194);
var seq18194__$1 = cljs.core.next.call(null,seq18194);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18195,seq18194__$1);
});
...
var vec__18208 = cljs.core.split_with.call(null,(function (p1__18207_SHARP_){
return cljs.core.not_EQ_.call(null,p1__18207_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__18208,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__18208,(1),null);
...
var vec__18211 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__18211,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__18211,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__18214 = cljs.core.rest.call(null,remaining_tokens);
var G__18215 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__18214;
name_tokens = G__18215;
continue;
} else {
...
var vec__18218 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__18218,(0),null);
var arity = cljs.core.nth.call(null,vec__18218,(1),null);
var vec__18221 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__18221,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__18221,(1),null);
var vec__18224 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__18224,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__18224,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__18224,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__18224,(3),null);
...
var vec__18230 = result;
var munged_ns = cljs.core.nth.call(null,vec__18230,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__18230,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__18230,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__18230,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__18230,(4),null);
var arity = cljs.core.nth.call(null,vec__18230,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__18234 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__18234,(0),null);
var args = cljs.core.nth.call(null,vec__18234,(1),null);
var vec__18237 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__18237,(0),null);
var name = cljs.core.nth.call(null,vec__18237,(1),null);
...
var G__18240 = (arity + (1));
var G__18241 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__18242){
var vec__18243 = p__18242;
var arity = cljs.core.nth.call(null,vec__18243,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__18243,(1),null);
...
return cljs.core.get.call(null,arities,p1__18246_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__18247_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___18254 = arguments.length;
var i__4500__auto___18255 = (0);
while(true){
if((i__4500__auto___18255 < len__4499__auto___18254)){
args__4502__auto__.push((arguments[i__4500__auto___18255]));

var G__18256 = (i__4500__auto___18255 + (1));
i__4500__auto___18255 = G__18256;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__18250){
var vec__18251 = p__18250;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__18251,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq18248){
var G__18249 = cljs.core.first.call(null,seq18248);
var seq18248__$1 = cljs.core.next.call(null,seq18248);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18249,seq18248__$1);
});
...
var G__18257 = arg;
var G__18257__$1 = (((G__18257 instanceof cljs.core.Keyword))?G__18257.fqn:null);
switch (G__18257__$1) {
...
var map__18259 = options;
var map__18259__$1 = ((((!((map__18259 == null)))?(((((map__18259.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__18259.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18259):map__18259);
var include_ns_QMARK_ = cljs.core.get.call(null,map__18259__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__18259__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__18259__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__18259__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__18260 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__18260,(0),null);
var fn_name = cljs.core.nth.call(null,vec__18260,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__18260,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__18260,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__18260,(4),null);
var arity = cljs.core.nth.call(null,vec__18260,(5),null);
...
var o__17292__auto__ = f;
return (o__17292__auto__["getBasis"]).call(o__17292__auto__);
});
/**
...
}catch (e18264){var _e__17299__auto__ = e18264;
...
var G__18265 = (obj[cljs.core.first.call(null,path)]);
var G__18266 = cljs.core.rest.call(null,path);
obj = G__18265;
path = G__18266;
continue;
} else {
...
return (function (accum,p__18267){
var vec__18268 = p__18267;
var bit = cljs.core.nth.call(null,vec__18268,(0),null);
var protocol = cljs.core.nth.call(null,vec__18268,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__18271){
var vec__18272 = p__18271;
var ns = cljs.core.nth.call(null,vec__18272,(0),null);
var name = cljs.core.nth.call(null,vec__18272,(1),null);
var selector = cljs.core.nth.call(null,vec__18272,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__18277,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__18277,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__18277,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__18275_SHARP_){
return (obj[cljs.core.first.call(null,p1__18275_SHARP_)]);
});})(name,sorted_matches,vec__18277,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
