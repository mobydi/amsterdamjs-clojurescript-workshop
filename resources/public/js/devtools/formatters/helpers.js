...
var G__18282 = devtools.prefs.pref.call(null,v);
v = G__18282;
continue;
} else {
return v;
...
}catch (e18285){var _e__17299__auto__ = e18285;
return false;
}})();
...
}catch (e18289){var _e__17299__auto__ = e18289;
return false;
}})();
...
}catch (e18291){var _e__17299__auto__ = e18291;
return false;
}}
}
});
...
var vec__18293 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__18293,(0),null);
var name = cljs.core.nth.call(null,vec__18293,(1),null);
...
return cljs.core.some.call(null,(function (p1__18296_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__18296_SHARP_);
}),template);
});
