...
var G__17087 = o;
(G__17087[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__17091 = o;
(G__17091[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__17096 = props;
var G__17096__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__17096,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__17096);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__17096__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__17097){
...
var props = map__17098__$1;
var class$ = cljs.core.get.call(null,map__17098__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__17098,map__17098__$1,props,class$){
return (function (c){
...
});})(map__17098,map__17098__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__17100){
...
var on_write = cljs.core.get.call(null,map__17101__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__17101,map__17101__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__17101,map__17101__$1,on_write))
);
} else {
...
var G__17104 = jsprops;
(G__17104["defaultValue"] = value);

(G__17104["onChange"] = ((function (G__17104,v,value,on_change){
return (function (p1__17103_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__17103_SHARP_);
});})(G__17104,v,value,on_change))
);
...
var vec__17107 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__17107,(0),null);
var id = cljs.core.nth.call(null,vec__17107,(1),null);
var class$ = cljs.core.nth.call(null,vec__17107,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___17111 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___17111 == null)){
} else {
var key_17112 = temp__5461__auto___17111;
(jsprops["key"] = key_17112);
}
...
var temp__5461__auto___17113 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___17113 == null)){
} else {
var key_17114 = temp__5461__auto___17113;
reagent.impl.template.oset.call(null,jsprops,"key",key_17114);
}
...
var G__17115 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__17115["name"] = c);
...
var len__4499__auto___17120 = arguments.length;
var i__4500__auto___17121 = (0);
while(true){
if((i__4500__auto___17121 < len__4499__auto___17120)){
args__4502__auto__.push((arguments[i__4500__auto___17121]));

var G__17122 = (i__4500__auto___17121 + (1));
i__4500__auto___17121 = G__17122;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq17118){
var G__17119 = cljs.core.first.call(null,seq17118);
var seq17118__$1 = cljs.core.next.call(null,seq17118);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17119,seq17118__$1);
});
...
break;
default:
var G__17125 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__17125;
continue;
...
var n__4376__auto___17127 = a.length;
var i_17128 = (0);
while(true){
if((i_17128 < n__4376__auto___17127)){
(a[i_17128] = reagent.impl.template.as_element.call(null,(a[i_17128])));

var G__17129 = (i_17128 + (1));
i_17128 = G__17129;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___17130 = a.length;
var i_17131 = (0);
while(true){
if((i_17131 < n__4376__auto___17130)){
var val_17132 = (a[i_17131]);
if(((cljs.core.vector_QMARK_.call(null,val_17132)) && ((reagent.impl.template.key_from_vec.call(null,val_17132) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_17131] = reagent.impl.template.as_element.call(null,val_17132));

var G__17133 = (i_17131 + (1));
i_17131 = G__17133;
continue;
} else {
}
...
var ctx = ({});
var vec__17134 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__17134,(0),null);
var derefed = cljs.core.nth.call(null,vec__17134,(1),null);
...
var G__17137 = (cljs.core.count.call(null,argv) - first_child);
switch (G__17137) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__17137){
